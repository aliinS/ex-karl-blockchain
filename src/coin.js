...
article.setAttribute("data-uuid", coin.uuid)
    ...
    article.style.borderColor = borderColorsWeDontWant.includes(coin.color) 
            ? "#73FDAA" 
            : coin.color; 

    //teeb border colori värviliseks. Võtab vastava värvi fetchitud failist. Ja kui on must, siis muudab värvi ära. ?=if
    // kui on true, siis lähen see värv 73fdaa sinna asemele, kui on false, siis lähen coin.color
